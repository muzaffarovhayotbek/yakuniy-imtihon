    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-purple-600 to-blue-600 p-6">
      <div className="w-full max-w-md bg-white p-6 rounded-lg shadow-lg">
        ...
        <form className="mt-6 space-y-4" onSubmit={handleLogin}>
          ...
          <button onClick={registerWithGoogle} className="w-full flex items-center justify-center gap-2 bg-black text-white p-3 rounded-md hover:bg-gray-800 transition">
            <span>Google</span>
