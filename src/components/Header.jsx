  ...
  return (
    <header className="mt-6 px-6 sm:mt-4">
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 p-3 rounded-lg shadow-md bg-white dark:bg-neutral-900">
        {/* Logo */}
        <Link
          className="flex items-center gap-3 text-2xl font-bold text-neutral-800 dark:text-white"
          to="/"
        >
        ...
        <div className="flex items-center gap-4">
          ...
          {/* User Name */}
          <div
            className={`flex items-center pl-4 font-medium ${
          ...
          <div className="relative">
            <div
              ...
              className="cursor-pointer flex items-center p-1 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-800"
            >
              <img
            ...
            {isMenuOpen && (
              <ul className="absolute right-0 mt-2 w-56 rounded-lg bg-white dark:bg-neutral-800 shadow-lg border border-gray-200 dark:border-neutral-700 z-50">
                ...
                <li className="px-4 py-2 hover:bg-gray-100 dark:hover:bg-neutral-700 cursor-pointer text-black">
                  <NavLink
                    to="/profile"
